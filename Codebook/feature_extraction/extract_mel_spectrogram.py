...
# if __name__ == '__main__':
#     paser = argparse.ArgumentParser()
#     paser.add_argument("-i", "--input_dir", default="/apdcephfs/share_1316500/donchaoyang/code3/data/audiocaps/train")
#     paser.add_argument("-o", "--output_dir", default="/apdcephfs/share_1316500/donchaoyang/code3/SpecVQGAN/data/audiocaps/features/train/melspec_10s_22050hz")
#     paser.add_argument("-l", "--length", default=220500)
#     paser.add_argument("-n", '--num_worker', type=int, default=32)
#     args = paser.parse_args()
#     input_dir = args.input_dir
